  ...
  const cards = [
    {
      ...
      type: 'VR project',
      title:
        'Mano-Aid provides cognitive behavioral therapy virtually to mental health patients',
      durationText: 'Since 2018',
      locationText: 'Chitkara University',
    },
    {
      imageSrc:
      ...
      company: 'HyperSpace AR',
      type: 'AR project',
      title:
        'HyperSpace helps students visualize math in a new and engaging way ',
      durationText: 'Since 2020',
      locationText: 'Chitkara University',
    },
  ];
  return (
